			...
			<div id="sitemap">
				...
				class="w3-bar-item w3-padding w3-text-teal"> JOIN.PROFILE</a></li></ul>
					...
					<li class="map_area">
						<h4>JOIN.TALK</h4>
						<ul>
						<li><a href="${pageContext.request.contextPath}/chatList" class="w3-bar-item w3-padding">MY TALK</a></li></ul>
					</li>
					<li class="map_area">
						<h4>JOIN.LOG</h4>
						<ul>
							<li><a href="${pageContext.request.contextPath}/myPlan" class="w3-bar-item w3-padding">MY PLAN</a></li>
